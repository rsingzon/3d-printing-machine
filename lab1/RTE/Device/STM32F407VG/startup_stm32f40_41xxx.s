...
; Assembly testbed
array_size EQU 1257							; Size of array
array_size_bytes EQU 1257*4					; Size of array in bytes
struct_size_bytes EQU 5 * 4					; Size of struct in bytes
kalman_struct EQU 0x20000000				; Start address of Kalman struct.  Address corresponds to the beginning of SRAM
filtered_array EQU kalman_struct+struct_size_bytes	; Pointer to filtered array

		LDR R0, =test_vector
		LDR R1, =filtered_array
		LDR R2, =kalman_struct
		LDR R3, =array_size
